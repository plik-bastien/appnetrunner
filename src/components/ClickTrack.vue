...
function onPick(idx:number){
  // Only double-clicking 1 resets to 0; other repeated clicks keep the value
...
<template>
  <div class="cp-panel px-2 py-2">
    <div class="flex items-center justify-between gap-3 w-full clicktrack-row">
      <span class="cp-title shrink-0">CLICS</span>
      <div class="flex items-center gap-3 shrink-0 clicktrack-buttons">
